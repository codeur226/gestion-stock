...
class Utilisateurs extends Component
{
    ...
    public function confirmPwdReset(){
        $this->dispatchBrowserEvent("showConfirmMessages", ["message"=> [
            "text" => "Vous êtes sur le point de réinitialisé le mot de passe de cet  utilisateur. 
    ...
    public function resetPassword(){
        ...
        $this->dispatchBrowserEvent("showSuccessMessage", ["message"=>"Mot de passe utilisateur reinitialisé  
        avec succès!"]);
    }
    ...
    public function deleteUser($id){
        ...
        $this->dispatchBrowserEvent("showSuccessMessage", ["message"=>"Utilisateur supprimé avec 
        succès!"]);
    }
}
